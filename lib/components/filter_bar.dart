...
class _FilterBarState extends State<FilterBar> {
  ...
  Widget build(BuildContext context) {
    List<Map<String, String>> filterData = mode == 'day' ? getPast7Days() : getPast6Months();
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          SizedBox(width: 26), // TODO, Change to arrow icon in 2.0
          Container(
            height: 27,
            ...
            child: SingleChildScrollView(
              ...
              child: Row(
                ...
                children: filterData.asMap().entries.map((entry) {
                  ...
                  bool isToday = DateTime.now().difference(dateValue).inDays == 0 &&
                                DateTime.now().day == dateValue.day;

                  // Modify label for today
                  String displayLabel = isToday ? 'Today $label' : dateValue.day.toString();
                  return Padding(
